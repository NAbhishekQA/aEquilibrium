...
import com.pages_script.AEquilibrium_UI_Pages;
import com.utils.ReadPropertiesFile;

public class AEquilibriumUI_Test extends Driver {
	...
	AEquilibrium_UI_Pages aEquilibrium_page;

	@BeforeClass
	public void init() {
		aEquilibrium_page = new AEquilibrium_UI_Pages(driver);
